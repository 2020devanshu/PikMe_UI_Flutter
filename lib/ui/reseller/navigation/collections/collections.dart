...
import 'package:pikmee/ui/reseller/category/category.dart';
import 'package:pikmee/ui/slider/slider.dart';

class RCollections extends StatefulWidget {
  @override
  _RCollectionsState createState() => _RCollectionsState();
}

class _RCollectionsState extends State<RCollections> {
                  ...
                  Expanded(
                    child: GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: (orientation == Orientation.portrait) ? 2 : 0.5,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                      child: Text("Fastees Polso T-Shirt",
                                        style: TextStyle(
                                            color: kBlackColor,
